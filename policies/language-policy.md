...
**Normative source: [ADR-0011 — Sprachen-Policy](../docs/adr/0011-sprachen-policy.md).** This file only satisfies the kickoff structure requirement (`policies/language-policy.md`, DoD item 4) and points there — it defines nothing of its own.
