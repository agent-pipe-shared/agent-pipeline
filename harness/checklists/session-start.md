...
- [ ] 5 Calibration exists + read at the resolved tier (`project/pipeline.json`, else `.claude/pipeline.json`); project denies present in `.claude/settings.json`/guard config
