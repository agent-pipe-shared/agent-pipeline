...
export const VENDORED_CANON_ALLOWLIST = Object.freeze([
  ...
  // docs/adr/0003-role-implementation-subagents.md (line 9, inherited canonical Governs metadata)
  { file: "plugins/pipeline-core/docs/adr/0003-role-implementation-subagents.md", match: "**Governs:** docs/operating-model.md, roles/elephant.md, roles/goldfish.md, roles/critic.md, harness/review-protocol.md, harness/checklists/goldfish-dispatch.md, harness/checklists/critic-review.md, templates/prompts/goldfish-task.md, templates/prompts/critic-review.md, plugins/pipeline-core/agents/goldfish-*.md, plugins/pipeline-core/agents/critic.md, plugins/pipeline-core/skills/critic-review/SKILL.md, harness/scripts/check-critic-contract-citations.mjs, harness/scripts/check-critic-contract-citations.test.mjs, plugins/pipeline-core/config/codex-sandbox-compatibility.v2.json, plugins/pipeline-core/config/codex-sandbox-compatibility.v2.schema.json, plugins/pipeline-core/lib/codex-sandbox-compatibility.mjs, plugins/pipeline-core/lib/codex-sandbox-compatibility.test.mjs, plugins/pipeline-core/scripts/critic-dispatch-preflight.mjs, plugins/pipeline-core/scripts/critic-dispatch-preflight.test.mjs, plugins/pipeline-core/scripts/critic-claude-host.mjs, plugins/pipeline-core/scripts/critic-claude-host.test.mjs, plugins/pipeline-core/scripts/critic-native-bare.mjs, plugins/pipeline-core/scripts/critic-bare.mjs, plugins/pipeline-core/scripts/critic-bare.test.mjs, plugins/pipeline-core/scripts/critic-verdict.schema.json, plugins/pipeline-core/scripts/codex-critic-host.mjs, plugins/pipeline-core/scripts/codex-critic-host.test.mjs, plugins/pipeline-core/scripts/codex-critic-selected-host.mjs, plugins/pipeline-core/scripts/codex-critic-app-server.mjs, plugins/pipeline-core/scripts/codex-critic-app-server-child.mjs, plugins/pipeline-core/scripts/sandboxed-readonly-host-bridge.mjs, plugins/pipeline-core/scripts/sandboxed-readonly-host-bridge.test.mjs, plugins/pipeline-core/scripts/codex-critic-receipt.schema.json, plugins/pipeline-core/scripts/codex-isolated-critic-contract.mjs, plugins/pipeline-core/scripts/codex-isolated-critic-contract.test.mjs", reason: vendoredCanonAllowlistReason("docs/adr/0003-role-implementation-subagents.md") }, // L9
  // docs/adr/0005-quality-gates-dod.md (line 5, inherited canonical Governs metadata)
  { file: "plugins/pipeline-core/docs/adr/0005-quality-gates-dod.md", match: "**Governs:** .claude/pipeline.json, .github/workflows/verify.yml, docs/operating-model.md, guardrails/quality-gates.md, harness/definition-of-done.md, harness/review-protocol.md, roles/goldfish.md, roles/critic.md, templates/prompts/goldfish-task.md, templates/prompts/critic-review.md, harness/scripts/verify.mjs, harness/scripts/verify-evidence-writer.mjs, harness/scripts/verify-evidence-writer.test.mjs, plugins/pipeline-core/hooks/hooks.json, plugins/pipeline-core/hooks/stop-suggest.mjs, plugins/pipeline-core/hooks/guard-push.mjs, plugins/pipeline-core/hooks/guard-push.test.mjs, plugins/pipeline-core/hooks/guard-testpath.mjs, plugins/pipeline-core/hooks/guard-testpath.test.mjs, plugins/pipeline-core/scripts/verify-evidence-producer.mjs, plugins/pipeline-core/scripts/verify-evidence-producer.test.mjs, plugins/pipeline-core/skills/critic-review/SKILL.md", reason: vendoredCanonAllowlistReason("docs/adr/0005-quality-gates-dod.md") }, // L5
  // docs/adr/0010-session-bootstrap.md (lines 21, 25, 69, 73)
  { file: "plugins/pipeline-core/docs/adr/0010-session-bootstrap.md", match: "**Governs:** harness/session-bootstrap.md, templates/prompts/session-bootstrap-check.md, plugins/pipeline-core/skills/pipeline-start/SKILL.md, plugins/pipeline-core/skills/pipeline-start/pipeline-start-v3.test.mjs, plugins/pipeline-core/scripts/pipeline-start-preflight.mjs, plugins/pipeline-core/scripts/pipeline-start-preflight.test.mjs, plugins/pipeline-core/scripts/v3-bootstrap-authority.mjs, plugins/pipeline-core/scripts/v3-bootstrap-authority.test.mjs, plugins/pipeline-core/scripts/onboarding-init.mjs, plugins/pipeline-core/scripts/onboarding-init.test.mjs, plugins/pipeline-core/lib/project-onboarding-v3.mjs, plugins/pipeline-core/lib/project-onboarding-v3.test.mjs, plugins/pipeline-core/lib/onboarding-continuity.mjs, plugins/pipeline-core/lib/onboarding-continuity.test.mjs, plugins/pipeline-core/lib/runner-profile-migration-v3.mjs, plugins/pipeline-core/lib/runner-profile-migration-v3.test.mjs, plugins/pipeline-core/lib/runtime-projection-v3.mjs, plugins/pipeline-core/lib/runtime-projection-v3.test.mjs, plugins/pipeline-core/lib/codex-onboarding-app-server.mjs, plugins/pipeline-core/lib/codex-onboarding-app-server.test.mjs, plugins/pipeline-core/lib/ruleset-source.mjs, plugins/pipeline-core/lib/bootstrap-payload-budget.mjs, plugins/pipeline-core/lib/bootstrap-payload-budget.test.mjs, plugins/pipeline-core/lib/session-cleanup-recovery.mjs, plugins/pipeline-core/lib/session-cleanup-recovery.test.mjs, plugins/pipeline-core/scripts/ruleset-freshness.mjs, plugins/pipeline-core/scripts/ruleset-freshness.test.mjs, plugins/pipeline-core/hooks/hooks.json, plugins/pipeline-core/hooks/guard-lifecycle-ready.mjs, plugins/pipeline-core/hooks/guard-lifecycle-ready.test.mjs, plugins/pipeline-core/hooks/staleness-check.mjs, plugins/pipeline-core/hooks/staleness-check.test.mjs, plugins/pipeline-core/hooks/codex-session-start-hint.mjs, plugins/pipeline-core/hooks/codex-session-start-hint.test.mjs, plugins/pipeline-core/hooks/antigravity-start-hint.mjs", reason: vendoredCanonAllowlistReason("docs/adr/0010-session-bootstrap.md") }, // L9
  ...
  // docs/adr/0014-critic-contract.md (line 7, inherited canonical Governs metadata)
  { file: "plugins/pipeline-core/docs/adr/0014-critic-contract.md", match: "**Governs:** docs/operating-model.md, roles/critic.md, harness/review-protocol.md, harness/checklists/critic-review.md, templates/prompts/critic-review.md, plugins/pipeline-core/agents/critic.md, plugins/pipeline-core/skills/critic-review/SKILL.md, harness/scripts/check-critic-contract-citations.mjs, harness/scripts/check-critic-contract-citations.test.mjs, plugins/pipeline-core/config/codex-sandbox-compatibility.v2.json, plugins/pipeline-core/config/codex-sandbox-compatibility.v2.schema.json, plugins/pipeline-core/lib/codex-sandbox-compatibility.mjs, plugins/pipeline-core/lib/codex-sandbox-compatibility.test.mjs, plugins/pipeline-core/scripts/critic-dispatch-preflight.mjs, plugins/pipeline-core/scripts/critic-dispatch-preflight.test.mjs, plugins/pipeline-core/scripts/critic-claude-host.mjs, plugins/pipeline-core/scripts/critic-claude-host.test.mjs, plugins/pipeline-core/scripts/critic-native-bare.mjs, plugins/pipeline-core/scripts/critic-bare.mjs, plugins/pipeline-core/scripts/critic-bare.test.mjs, plugins/pipeline-core/scripts/critic-verdict.schema.json, plugins/pipeline-core/scripts/codex-critic-host.mjs, plugins/pipeline-core/scripts/codex-critic-host.test.mjs, plugins/pipeline-core/scripts/codex-critic-selected-host.mjs, plugins/pipeline-core/scripts/codex-critic-app-server.mjs, plugins/pipeline-core/scripts/codex-critic-app-server-child.mjs, plugins/pipeline-core/scripts/sandboxed-readonly-host-bridge.mjs, plugins/pipeline-core/scripts/sandboxed-readonly-host-bridge.test.mjs, plugins/pipeline-core/scripts/codex-critic-receipt.schema.json, plugins/pipeline-core/scripts/codex-isolated-critic-contract.mjs, plugins/pipeline-core/scripts/codex-isolated-critic-contract.test.mjs", reason: vendoredCanonAllowlistReason("docs/adr/0014-critic-contract.md") }, // L7
  ...
  // docs/adr/0033-release-promotion-phase.md (line 9, inherited canonical Governs metadata)
  { file: "plugins/pipeline-core/docs/adr/0033-release-promotion-phase.md", match: "**Governs:** docs/operating-model.md, guardrails/deploy.md, docs/push-release-flow.md, harness/scripts/validate-manifest.mjs, harness/scripts/validate-manifest.test.mjs, plugins/pipeline-core/scripts/deploy-policy.schema.json, plugins/pipeline-core/scripts/release-preflight.mjs, plugins/pipeline-core/scripts/release-preflight.test.mjs, plugins/pipeline-core/scripts/release-preflight-cli.mjs, plugins/pipeline-core/scripts/release-preflight-cli.test.mjs, plugins/pipeline-core/scripts/release-version-plan.mjs, plugins/pipeline-core/scripts/release-version-plan.test.mjs, plugins/pipeline-core/scripts/check-release-state-consistency.mjs, plugins/pipeline-core/scripts/check-release-state-consistency.test.mjs, plugins/pipeline-core/scripts/publication-executor.mjs, plugins/pipeline-core/scripts/publication-executor.test.mjs, plugins/pipeline-core/scripts/publication-executor-v2.test.mjs, plugins/pipeline-core/scripts/publication-gate-evidence.mjs, plugins/pipeline-core/scripts/publication-gate-evidence.test.mjs, plugins/pipeline-core/scripts/pipeline-state.mjs, plugins/pipeline-core/scripts/pipeline-state.test.mjs, harness/scripts/verify.mjs, .github/workflows/verify.yml, harness/scripts/generate-vendored-canon.mjs, plugins/pipeline-core/guardrails/deploy.md, plugins/pipeline-core/docs/adr/0033-release-promotion-phase.md", reason: vendoredCanonAllowlistReason("docs/adr/0033-release-promotion-phase.md") }, // L9
  // docs/adr/0081-boundary-aware-impacted-verify.md (line 3, inherited canonical Governs metadata)
  { file: "plugins/pipeline-core/docs/adr/0081-boundary-aware-impacted-verify.md", match: "**Governs:** .github/workflows/verify.yml, docs/operating-model.md, docs/push-release-flow.md, docs/usage.md, guardrails/quality-gates.md, harness/scripts/self-verify-selection.mjs, harness/scripts/verify.mjs, plugins/pipeline-core/hooks/guard-push.mjs, plugins/pipeline-core/lib/consumer-baseline-verify.mjs, plugins/pipeline-core/lib/consumer-verify.mjs, plugins/pipeline-core/lib/human-guard-override.mjs, plugins/pipeline-core/lib/project-onboarding-v3.mjs, plugins/pipeline-core/lib/verify-selection.mjs, plugins/pipeline-core/scripts/codex-critic-host.mjs, plugins/pipeline-core/scripts/consumer-verify-check.mjs, plugins/pipeline-core/scripts/critic-dispatch-preflight.mjs, plugins/pipeline-core/scripts/pipeline-state.mjs, plugins/pipeline-core/scripts/publication-gate-evidence.mjs, plugins/pipeline-core/scripts/push-gate-satisfiability.mjs, plugins/pipeline-core/scripts/push-prepare.mjs, plugins/pipeline-core/scripts/verify-evidence-producer.mjs, plugins/pipeline-core/scripts/verify-evidence.schema.json, plugins/pipeline-core/scripts/verify-journal.mjs", reason: vendoredCanonAllowlistReason("docs/adr/0081-boundary-aware-impacted-verify.md") }, // L3
