...
export const KNOWN_TOP_LEVEL_DIRS = Object.freeze({
  ...
  architecture: "Repository architecture map bundle and concepts (AC-23) — OKF v0.1 architectural navigation bundle.",
  ...
  schemas: "Top-level JSON Schema catalog for pipeline protocols, evidence, and contracts — pre-existing repository infrastructure, not an ADR-0063 kind.",
