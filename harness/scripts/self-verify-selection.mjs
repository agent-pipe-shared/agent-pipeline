      ...
      areas: [
        { id: "documentation", paths: ["README.md", "PIPELINE_FLOW.md", "SETUP.md", "docs/**", "specs/**", "backlog/**"], suites: documentation },
        {
          ...
          paths: [
            ...
            "plugins/pipeline-core/hooks/guard-lifecycle-recovery-contract.test.mjs",
            ...
            "plugins/pipeline-core/scripts/installed-plugin-attestation-host.test.mjs",
            ...
            "plugins/pipeline-core/scripts/settings-allowlist-merge.test.mjs",
          ],
          suites: [
