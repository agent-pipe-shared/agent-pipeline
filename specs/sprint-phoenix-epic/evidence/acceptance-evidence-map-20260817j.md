...
**Phoenix cannot claim complete.** 139 of 157 criteria carry a named assertion in a
gate-registered suite; 18 do not. EPIC-AC-05 forbids a completion claim while any
...
### H — Human Governance Decision Ledger (#30) (13/15 implemented)
...
### A — Agent Decision and Assumption Journal (#31) (12/16 implemented)
...
### P — Policy packs and signed audit bundles (#9) (12/13 implemented)
...
7 of 11 live acceptance bullets fully carried; **4 blocked**.
...
14 of 17 live acceptance bullets fully carried; **3 blocked**.
...
| 3 | Guard/plan/release/deploy/override paths reference decision IDs | H-AC-12 (partial) |
...
7 distinct criteria block at least one live acceptance bullet.
...
11 of those 53 are currently not `implemented` and are listed below; the rest are omitted because they are done.
