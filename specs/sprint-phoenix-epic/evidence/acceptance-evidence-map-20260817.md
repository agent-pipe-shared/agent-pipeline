...
**Phoenix cannot claim complete.** 131 of 157 criteria carry a named assertion in a
gate-registered suite; 26 do not. EPIC-AC-05 forbids a completion claim while any
...
Issues closeable on their own live acceptance bullets: **4 of 8**.

## The blocking set, ranked

12 distinct criteria block at least one live acceptance bullet.
...
14 of those 53 are currently not `implemented` and are listed below; the rest are omitted because they are done.
