...
w('  built" absent such an adapter. A warn-only same-repo concurrent-session mitigation shipped');
w('  (PHX-WP-AAC01-MULTISESSION, commit `645de988`) but does not touch this gap by design.');
w();
