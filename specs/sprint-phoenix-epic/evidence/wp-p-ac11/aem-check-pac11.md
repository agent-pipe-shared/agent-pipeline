...
**Phoenix cannot claim complete.** 113 of 157 criteria carry a named assertion in a
gate-registered suite; 44 do not. EPIC-AC-05 forbids a completion claim while any
...
### C — ITSM change control (#24) (11/13 implemented)
...
### E — Governance event export (#32) (17/21 implemented)
...
### R — External command offer, workaround and recovery audit profile (7/13 implemented)
...
10 of 12 live acceptance bullets fully carried; **2 blocked**.
...
16 of 20 live acceptance bullets fully carried; **4 blocked**.
...
| 3 | Required mode blocks only exact named boundary/range | E-AC-10 (not-started) |
| 4 | #9 bundles sanitized export-policy/delivery metadata | E-AC-20 (not-started) |
...
23 distinct criteria block at least one live acceptance bullet.
...
21 of those 53 are currently not `implemented` and are listed below; the rest are omitted because they are done.
