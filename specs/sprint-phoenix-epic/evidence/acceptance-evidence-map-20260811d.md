...
**Phoenix cannot claim complete.** 127 of 157 criteria carry a named assertion in a
gate-registered suite; 30 do not. EPIC-AC-05 forbids a completion claim while any
...
### A — Agent Decision and Assumption Journal (#31) (10/16 implemented)
...
### P — Policy packs and signed audit bundles (#9) (9/13 implemented)
...
### E — Governance event export (#32) (20/21 implemented)
...
### R — External command offer, workaround and recovery audit profile (10/13 implemented)
...
| 5 | Complete assumption/selection/failure/privacy fixture set | A-AC-14 (partial) |

### #32 — Add provider-neutral governance event export for SIEM and audit platforms

19 of 20 live acceptance bullets fully carried; **1 blocked**.

| # | live acceptance bullet | blocking criteria (verdict) |
|---|---|---|
| 1 | Cursor/gap/fork/hash/schema/ack failures are typed | E-AC-08 (partial) |
...
Issues closeable on their own live acceptance bullets: **3 of 8**.

## The blocking set, ranked

13 distinct criteria block at least one live acceptance bullet.
...
17 of those 53 are currently not `implemented` and are listed below; the rest are omitted because they are done.
