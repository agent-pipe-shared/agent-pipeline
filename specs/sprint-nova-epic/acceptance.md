...
| NVA-G15 | A durable authorization for push, human-gated deploy or publication SHALL require an exact externally verified human proof bound to the clean candidate, bound PRD/Spec, closed action kind and writer-owned action subject. Chat approval or attribution alone SHALL fail closed at those boundaries. | Positive/negative critical-proof and state-writer tests, including candidate/subject/kind/expiry/replay cases. |
