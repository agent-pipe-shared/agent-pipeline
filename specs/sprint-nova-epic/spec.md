...
| B2-I | ADR-0049 plus exact local manifest: `specs/sprint-nova-epic/design/b2-i-gitlab-ci-pilot.md` | local contract only; live pilot needs exact target/YAML/credential preview, confirmation and readback |
