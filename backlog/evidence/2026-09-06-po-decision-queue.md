...
| V3 migration recovery review | Historical whole-process startup failure remains diagnosed; do not retry it unchanged. The native lane completed a real new-preflight review at `04e5883b`, following fresh exact 517/517 Verify and native smoke. Its two major findings were repaired in `0e8732a0` with 14/14 runtime and 9/9 consumer tests; fresh full Verify and the single correction review remain pending. See `2026-09-09-native-preflight-critic-round-1.json`. Migration correction and broader candidate coverage remain open. | None for these repairs or the already approved native route. This is technical work, not a request to waive review or grant host-home writes. |
