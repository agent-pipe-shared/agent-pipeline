...
| --- | --- | --- | --- | --- | --- |
| pipeline.afk-assumption-mode | open | workflow-improvement | pipeline | 2026-07-19 | Sentinel recovery baseline; no completion claim. |
| pipeline.canonical-worktree-lifecycle | open | defect | pipeline | 2026-07-19 | Sentinel recovery baseline; no completion claim. |
...
| pipeline.codex-plugin-validator-host-parity | open | workflow-improvement | pipeline | 2026-07-19 | Sentinel recovery baseline; no completion claim. |
| pipeline.codex-sandbox-critic-longterm | open | defect | pipeline | 2026-07-19 | Sentinel recovery baseline; no completion claim. |
