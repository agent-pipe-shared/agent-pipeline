...
id: "pipeline.dual-channel-publication"
...
- **Rationale:** already informally confirmed as Nightwing scope in
  ...
  documentation and low-friction adoption" — publication channels are
  product-front-door territory). Nightwing is not yet an active Sprint
  (follows Phoenix/Nova), so this stays `open` without a status change.
