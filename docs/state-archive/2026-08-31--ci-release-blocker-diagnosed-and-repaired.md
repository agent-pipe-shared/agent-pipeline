# Handover archive -- Current handover — the release is blocked by CI, not by the candidate (2026-08-31)

> Rotated from `docs/state.md` on 2026-08-31 by `plugins/pipeline-core/scripts/handover-rotate.mjs` (ADR-0066).
> Section(s) archived: Current handover — the release is blocked by CI, not by the candidate (2026-08-31).
> Summary: The CI release blocker: diagnosis, the measured repair at ed491309, the PO decision to repair rather than bypass, and the inverted push-before-CI sequencing. Its live carry-forwards were extracted into the 2026-08-31 release handover before rotation.
