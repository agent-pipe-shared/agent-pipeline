# Handover archive -- Prior handover — ledger-merge capability, ADR renumbering, handover rotation (2026-08-27)

> Rotated from `docs/state.md` on 2026-08-28 by `plugins/pipeline-core/scripts/handover-rotate.mjs` (ADR-0066).
> Section(s) archived: Prior handover — ledger-merge capability, ADR renumbering, handover rotation (2026-08-27).
> Summary: Nova line: backlog-ledger merge semantics (ADR-0068), ADR renumbering (ADR-0069) and the first handover rotation
