...
**Last updated:** 2026-08-17 (NVA-SIGDISCLOSE-1 and NVA-GITID-1 landed, three live Windows findings from a Toolbox session filed, full AFK mode reactivated for the night — see "2026-08-17 (continued 16)" below, which is now the current block)
