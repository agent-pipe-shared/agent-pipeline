...
**Next planned step:** continue Wave 5 with a round 2 batch drawn from the corrected (post-exclusion) remainder, prioritizing well-scoped non-TP-protected items first, same as round 1's selection strategy.
