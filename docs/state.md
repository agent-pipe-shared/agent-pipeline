...
- **GF-115 (`plugins/pipeline-core/scripts/pipeline-start-preflight.mjs`):** implements the PO's project-shadows-user precedence decision above — dispatched `goldfish-deep`, status pending at this write.
