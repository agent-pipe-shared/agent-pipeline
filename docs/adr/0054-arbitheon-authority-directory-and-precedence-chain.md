...
**Governs:** pipeline.user.yaml, setup.mjs, setup.test.mjs, harness/scripts/check-claude-md-lines.mjs, harness/scripts/check-po-language-projection.mjs, harness/scripts/check-doc-contracts.mjs, harness/scripts/check-doc-contracts.test.mjs, harness/scripts/verify.mjs, plugins/pipeline-core/lib/project-authority.mjs, plugins/pipeline-core/lib/project-authority.test.mjs, plugins/pipeline-core/scripts/project-authority-migration.mjs, plugins/pipeline-core/scripts/project-authority-migration.test.mjs, plugins/pipeline-core/scripts/check-routing-projections.mjs, plugins/pipeline-core/scripts/check-routing-projections.test.mjs, plugins/pipeline-core/scripts/session-power.mjs, plugins/pipeline-core/scripts/session-power.test.mjs, plugins/pipeline-core/scripts/toolchain-preflight.mjs, plugins/pipeline-core/scripts/toolchain-preflight.test.mjs, plugins/pipeline-core/scripts/check-artifact-lifecycle.mjs, plugins/pipeline-core/scripts/check-artifact-lifecycle.test.mjs, plugins/pipeline-core/hooks/codex-pretool-guard.mjs, plugins/pipeline-core/hooks/codex-pretool-guard.test.mjs, plugins/pipeline-core/hooks/antigravity-pretool-guard.mjs, plugins/pipeline-core/hooks/antigravity-pretool-guard.test.mjs, plugins/pipeline-core/hooks/codex-session-start-hint.mjs, plugins/pipeline-core/hooks/codex-session-start-hint.test.mjs, plugins/pipeline-core/hooks/guard-lifecycle-ready.mjs, plugins/pipeline-core/hooks/guard-lifecycle-ready.test.mjs, plugins/pipeline-core/lib/human-guard-override.mjs, plugins/pipeline-core/lib/human-guard-override.test.mjs, plugins/pipeline-core/lib/critic-packet-governance.mjs, plugins/pipeline-core/lib/critic-packet-governance.test.mjs, plugins/pipeline-core/hooks/guard-devplan.mjs, plugins/pipeline-core/hooks/guard-devplan.test.mjs, plugins/pipeline-core/lib/review-economy.mjs, plugins/pipeline-core/lib/review-economy.test.mjs, plugins/pipeline-core/scripts/codex-critic-host.mjs, plugins/pipeline-core/scripts/codex-critic-host.test.mjs, plugins/pipeline-core/lib/project-onboarding-v3.mjs, plugins/pipeline-core/lib/project-onboarding-v3.test.mjs, plugins/pipeline-core/lib/runner-profile-migration-v3.mjs, plugins/pipeline-core/lib/runner-profile-migration-v3.test.mjs, plugins/pipeline-core/lib/runtime-projection-v3.mjs, plugins/pipeline-core/lib/runtime-projection-v3.test.mjs, plugins/pipeline-core/scripts/private-overlay-activation.mjs, plugins/pipeline-core/scripts/private-overlay-activation.test.mjs, plugins/pipeline-core/scripts/critic-dispatch-preflight.mjs, plugins/pipeline-core/scripts/critic-dispatch-preflight.test.mjs
