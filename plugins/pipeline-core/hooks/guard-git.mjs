 ...
 *
 * OVERRIDE MECHANISM
 *   Every union or raw-string deny rule carries a stable id (GG-01…GG-16, file order,
 *   append-only, never renumbered); project extra denies get PX-<n> (1-based
 *   config-list index) or an explicit "id". Every BLOCK message prints the matching
 *   rule's id — the `OVERRIDE <rule-id>` phrase (guardrails/git.md GIT-04 step 3) needs
 *   a referent.
 *
