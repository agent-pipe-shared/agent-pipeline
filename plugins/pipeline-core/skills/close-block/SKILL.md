...
- [ ] **No guardrail/canon diff:** no changes to `docs/operating-model.md`, `roles/*`, `policies/*`,
      ...
      calibration at its resolved authority tier (`project/pipeline.json`, else
