...
check("short, upper-case, extra and unknown arguments fail closed", () => {
  for (const argv of [[], ["--commit", "a".repeat(39)], ["--commit", "A".repeat(40)], ["--commit", "a".repeat(40), "extra"], ["--commit", "a".repeat(40), "--lease-ms", "300000"], ["--branch", "main"]]) assert.throws(() => parseArgs(argv));
});
