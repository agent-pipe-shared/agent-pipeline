...
// `/tmp` is intentionally untrusted (sticky and world-writable). This fixture
// needs a private state root, so keep it below the checkout and clean it up.
const stateHome = mkdtempSync(join(process.cwd(), ".local-supervisor-cli-"));
try {
