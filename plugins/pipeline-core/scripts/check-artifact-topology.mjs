...
export const TOPOLOGY_CLASSES = Object.freeze(["prd", "spec", "design", "plan", "acceptance", "result", "candidate-evidence", "adr", "release", "backlog", "state", "handover", "retention", "supply-chain", "threat-model", "security-readiness", "private-local", "governance-event"]);
