...
**Status:** accepted (2026-07-11, sub-spec `specs/2026-07-11-sdlc-release-deploy/spec_s1-canon.md`, umbrella `specs/2026-07-11-sdlc-release-deploy/spec.md` §2.1/§2.5) · **Basis:** `docs/operating-model.md` §3.1, PO decisions (2026-07-11)
...
An OPTIONAL tail phase **Release/Promotion**, activated by a `release` section in the project manifest (`.claude/pipeline.yaml`). Flow (detail: `docs/operating-model.md` §3.1):
...
**Status:** akzeptiert (2026-07-11, Sub-Spec `specs/2026-07-11-sdlc-release-deploy/spec_s1-canon.md`, Umbrella `specs/2026-07-11-sdlc-release-deploy/spec.md` §2.1/§2.5) · **Grundlage:** `docs/operating-model.md` §3.1, PO-Entscheidungen (2026-07-11)
...
Eine OPTIONALE Tail-Phase **Release/Promotion**, aktiviert durch eine `release`-Sektion im Projekt-Manifest (`.claude/pipeline.yaml`). Fluss (Detail: `docs/operating-model.md` §3.1):
