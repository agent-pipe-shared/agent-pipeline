...
function outcomeOf(receipt, route, dispatchBinding, trustedEvidence, adapter) {
  try {
    return {
      threw: false,
      result: validateRouteReceipt(receipt, route, dispatchBinding, trustedEvidence, undefined, adapter),
    };
  } catch (error) {
...
function accepts(receipt, route, dispatchBinding, trustedEvidence, adapter) {
...
function rejects(receipt, route, dispatchBinding, trustedEvidence, adapter) {
  const outcome = outcomeOf(receipt, route, dispatchBinding, trustedEvidence, adapter);
