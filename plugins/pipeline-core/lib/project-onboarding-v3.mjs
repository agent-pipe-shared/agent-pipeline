...
const PROJECT_IGNORE_SEED = [
  ...
  "/scratch/",
  "",
  "# Kickoff's deterministic staging draft: pre-binding scratch state that",
  "# must be authored and reviewed before binding, same class as specs/kickoff-*.",
  "/project/.onboarding-staging/",
  "",
