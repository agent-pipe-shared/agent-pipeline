...
import { createThreatEntityId, evaluateThreatImpact, evaluateThreatModelApplicability, evaluateThreatTraceability } from "./threat-model.mjs";
...
console.log("7 threat-model checks passed");
