...
/** Like `sameOffer`, minus `candidateDigest`: a recovery is deliberately allowed to name a different candidate than the one it anchors against -- that is what "alternative" means -- but never a different repository, scope, or policy context. */
